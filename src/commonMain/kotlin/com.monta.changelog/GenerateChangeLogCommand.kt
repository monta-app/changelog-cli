...
\ \ \-./\ \\ \ \/\ \\ \ \-.  \\/_/\ \/\ \  __ \
 \ \_\ \ \_\\ \_____\\ \_\\"\_\  \ \_\ \ \_\ \_\
  \/_/  \/_/ \/_____/ \/_/ \/_/   \/_/  \/_/\/_/
    ...
    private val commentOnJira: Boolean by option(
        "--comment-on-jira",
        help = "Comment on JIRA tickets with production deployment information (requires stage=production and deployment times)",
