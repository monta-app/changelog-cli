...
kotlin {
    ...
    sourceSets {
        ...
        val commonTest by getting {
            dependencies {
                implementation("io.kotest:kotest-framework-engine:6.1.9")
                implementation("io.kotest:kotest-assertions-core:6.1.9")
            }
        }
        ...
        val jvmTest by getting {
            dependencies {
                implementation("io.kotest:kotest-runner-junit5:6.1.9")
            }
        }
